...
SET(URL_WXWIDGETS "https://github.com/RoEdAl/ucrt-wxwidgets-builds/releases/download/v${WXWIDGETS_VERSION}-ucrt")
IF(INSTALL_MSVC)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-dbg-${WXWIDGETS_VERSION}-win64.7z c38b092472ff02d5b98766e7316a9d81245bee0f "wxWidgets dev libraries [MSVC x64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-${WXWIDGETS_VERSION}-win64.7z 091072a608b1bd6f88a1c5959346f12e4f503b01 "wxWidgets libraries [MSVC x64]")
ENDIF()

IF(INSTALL_MINGW64)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-dbg-${WXWIDGETS_VERSION}-win64.7z 59585cecbc23d3247281d9641f0c5a9130091f32 "wxWidgets dev libraries [MinGW64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-${WXWIDGETS_VERSION}-win64.7z ab029d0c2adc70dc467b5c731f736fd5fc2b58d0 "wxWidgets libraries [MinGW64]")
