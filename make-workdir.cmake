...
SET(URL_WXWIDGETS "https://github.com/RoEdAl/wxwidgets-builds/releases/download/v${WXWIDGETS_VERSION}-build5")
IF(INSTALL_MSVC)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-dbg-${WXWIDGETS_VERSION}-win64.7z 556845ffcf8543fd5a15cddb50a13a9ed8d42959 "wxWidgets dev libraries [MSVC x64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-vc-${WXWIDGETS_VERSION}-win64.7z 5708282a8da9529579b1d28aa59aa5812db40aa3 "wxWidgets libraries [MSVC x64]")
ENDIF()

IF(INSTALL_MINGW64)
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-dbg-${WXWIDGETS_VERSION}-win64.7z 80387d4b6d66559f25dbe7340298087c7e776259 "wxWidgets dev libraries [MinGW64]")
	DownloadPkgSha1(${URL_WXWIDGETS} wxWidgets-gcc-${WXWIDGETS_VERSION}-win64.7z ddc9e9d71071eebc016ef4f59a559ada6e54dcb6 "wxWidgets libraries [MinGW64]")
