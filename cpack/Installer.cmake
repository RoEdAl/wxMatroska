...
FOREACH(LIBPATH $<TARGET_RUNTIME_DLLS:wxCueChapters>)
	...
	EXECUTE_PROCESS(COMMAND "@STRIP_EXE@" --preserve-dates $<IF:$<CONFIG:Debug,RelWithDebInfo>,--only-keep-debug,--strip-unneeded> "${LIBPATH}" -o ${LIBNAME} ENCODING UTF-8 WORKING_DIRECTORY ${CMAKE_INSTALL_PREFIX}/cue2mkc COMMAND_ERROR_IS_FATAL ANY)
ENDFOREACH()
]=] INSTALL_SCRIPT @ONLY)
	INSTALL(CODE "${INSTALL_SCRIPT}" COMPONENT cue2mkc EXCLUDE_FROM_ALL)
ENDIF()
