...
const char wxDashesCorrector::REG_EX_EN[] = "\\p{Z}+\\p{Pd}\\p{Z}+";
const char wxDashesCorrector::REG_EX_EM[]  = "\\p{Z}+\\p{Pd}{2}\\p{Z}+";
const char wxDashesCorrector::REG_EX_EM2[] = "\\p{Z}+\\p{Pd}{3,}\\p{Z}+";
