...
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupOther = GUICtrlCreateGroup("&Other options", 276, 187, 233, 95, -1, $WS_EX_TRANSPARENT)
GUICtrlSetFont(-1, 8, 400, 0, "Microsoft Sans Serif")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
...
$CheckBoxMLang = GUICtrlCreateCheckbox("Use MLang library", 280, 235, 117, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
$CheckBoxArtistForTrack = GUICtrlCreateCheckbox("Generate ARTIST tag for tracks", 280, 251, 180, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
