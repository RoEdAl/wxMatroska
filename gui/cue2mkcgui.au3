...
GUICtrlSetFont(-1, 8, 400, 0, @OSVersion = "WIN_10"? "Consolas" : "Lucida Console")
...
GUICtrlSetResizing(-1, $GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$InputDoe = GUICtrlCreateInput("json", 389, 107, 53, 21, $GUI_SS_DEFAULT_INPUT)
GUICtrlSetLimit(-1, 50)
GUICtrlSetResizing(-1, $GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlCreateGroup("", -99, -99, 1, 1)
