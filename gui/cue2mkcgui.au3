...
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupOutputOptions = GUICtrlCreateGroup("&Output", 4, 157, 265, 125)
GUICtrlSetFont(-1, 8, 400, 0, "Microsoft Sans Serif")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
...
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxK = GUICtrlCreateCheckbox("Generate options file for mkvmerge", 26, 211, 213, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$LabelLang = GUICtrlCreateLabel("Language:", 26, 227, 53, 21, $SS_CENTERIMAGE)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$InputLang = GUICtrlCreateInput("eng", 84, 227, 41, 21, $GUI_SS_DEFAULT_INPUT)
GUICtrlSetLimit(-1, 3)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "This option also affects tags file generation")
$LabelCueSheetEncoding = GUICtrlCreateLabel("&Encoding:", 8, 250, 55, 21, $SS_CENTERIMAGE)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Encoding of generated text files.")
$ComboCueSheetEncoding = GUICtrlCreateCombo("", 73, 250, 141, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL), $WS_EX_CLIENTEDGE)
GUICtrlSetData(-1, "default|UTF-8|UTF-8 with BOM|UTF-16|UTF-16 with BOM|UTF-16BE|UTF-16BE with BOM")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupTags = GUICtrlCreateGroup("&Tags parsing", 276, 27, 233, 117)
GUICtrlSetFont(-1, 8, 400, 0, "Microsoft Sans Serif")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
...
GUICtrlSetTip(-1, "Use Unicode characters for Roman Numerals when possilble")
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupUsedTags = GUICtrlCreateGroup("&Used tags", 276, 147, 233, 72, -1, $WS_EX_TRANSPARENT)
GUICtrlSetFont(-1, 8, 400, 0, "Microsoft Sans Serif")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxTagUseCdText = GUICtrlCreateCheckbox("Use CD-TEXT tags", 280, 163, 125, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Use CD-TEXT tags")
$CheckBoxTagUseCueComments = GUICtrlCreateCheckbox("Use tags from cuesheet comments", 280, 180, 205, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Use tags taken from cuesheet comments")
$CheckBoxTagUseFromMedia = GUICtrlCreateCheckbox("Use tags from media file(s)", 280, 196, 161, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Use tags taken from media's metadata")
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupOther = GUICtrlCreateGroup("&Other options", 276, 225, 233, 111, -1, $WS_EX_TRANSPARENT)
GUICtrlSetFont(-1, 8, 400, 0, "Microsoft Sans Serif")
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxEu = GUICtrlCreateCheckbox("Generate edition UID", 280, 241, 129, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxReadMetadata = GUICtrlCreateCheckbox("Read metadata", 280, 257, 101, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Read metadata from media file")
$CheckBoxMLang = GUICtrlCreateCheckbox("Use MLang library", 280, 273, 117, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxArtistForTrack = GUICtrlCreateCheckbox("Generate ARTIST tag for tracks", 280, 289, 180, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
...
GUICtrlSetResizing(-1, $GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GroupMkvmerge = GUICtrlCreateGroup("mkvmerge", 4, 24, 277, 197)
...
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxJpegCovers = GUICtrlCreateCheckbox("Convert covers to JPEG format", 8, 101, 172, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$LabelJpegQuality = GUICtrlCreateLabel("JPEG quality:", 8, 123, 69, 21, $SS_CENTERIMAGE)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$InputJpegQuality = GUICtrlCreateInput("80", 84, 123, 41, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_NUMBER))
GUICtrlSetLimit(-1, 3)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "This option also affects tags file generation")
$LabelMkvmergeDir = GUICtrlCreateLabel("Location:", 10, 152, 51, 21, $SS_CENTERIMAGE)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Directory where mkvmerge tool resides")
$InputMkvmergeDir = GUICtrlCreateInput("", 61, 152, 181, 21, $GUI_SS_DEFAULT_INPUT)
GUICtrlSetLimit(-1, 50)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKHEIGHT)
$ButtonMkvmergeDir = GUICtrlCreateButton("1", 244, 152, 29, 21, $BS_NOTIFY)
GUICtrlSetFont(-1, 10, 400, 0, "Wingdings")
GUICtrlSetResizing(-1, $GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlSetTip(-1, "Specify output directory or file")
$CheckBoxRunMkvmerge = GUICtrlCreateCheckbox("Run mkvmerge after options file generation", 8, 174, 229, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$CheckBoxFullPaths = GUICtrlCreateCheckbox("Generate full paths in options file", 8, 190, 181, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
GUICtrlCreateGroup("", -99, -99, 1, 1)
...
Func set_default_options()
	...
	GUICtrlSetData($InputMkvmergeDir, "")
