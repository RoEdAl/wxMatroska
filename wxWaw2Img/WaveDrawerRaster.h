...
class RasterWaveDrawer :public GraphicsContextWaveDrawer
{
	...
	static wxImage create_log_gradient_bitmap( wxMemoryDC&, const wxColour&, const wxColour&, wxUint32, wxFloat32 );
	static wxImage create_log_gradient_bitmap( const wxColour&, const wxColour&, wxUint32, wxFloat32 );

	private:

	static wxImage draw_gradient_bitmap( wxMemoryDC&, const wxColour&, const wxColour&, wxUint32 );
	static wxImage draw_log_gradient_bitmap( wxMemoryDC&, const wxColour&, const wxColour&, wxUint32, wxFloat32 );
