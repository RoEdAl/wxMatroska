...
bool DrawerSettings::OneMiddleColour() const
{
	return m_topColourSettings.GetMiddleColour() == m_bottomColourSettings.GetMiddleColour();
}

bool DrawerSettings::OneEdgeColour() const
{
